...
description: 运用费曼学习法（teach-back）、苏格拉底追问、证据核验、渐进提示、反例和迁移测试，帮助用户真正掌握任意主题。用于用户表示“我好像懂了但讲不清”“考考我或检查理解”“用费曼学习法带我学”“帮我快速弄懂这段代码、文档、业务、流程或概念”“让我能向别人讲清楚”，以及刚完成或接手陌生工作却尚未形成可靠心智模型时。适用于代码、技术系统、论文、课程、产品与业务机制、操作流程和决策方案；不用于用户只要直接答案、普通摘要或代写且没有学习意图的请求。
---

# 费曼学习法：讲清楚才算懂

以费曼学习法的“亲自讲解—暴露漏洞—补足理解—重新简化”为主轴，并加入证据核验、苏格拉底追问、反例和迁移测试。目标不是让解释“听起来清楚”，而是让用户能够不依赖原材料讲清机制、指出边界，并把理解用于新情境。

## 核心规则

- 先问后讲：先让用户预测、复述或推演，再提供答案。
...
默认采用标准模式：事实核验、数轮追问、一次迁移验证。用户要求“快速”时采用快速模式，只选一个关键机制，完成一次复述、一个漏洞修复和一个新情境验证。用户准备承担重要决策、教学、评审或高风险操作时采用深入模式，增加来源核验、替代方案、边界和故障推演。

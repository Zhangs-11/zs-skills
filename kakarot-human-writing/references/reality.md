...
第一人称的解释性补写也属于新增经历。用户只说“我有时只报好消息”，不能顺手补成“父母听不了坏消息”“小时候我总相信大人知道答案”“挂完电话后我独自消化”。这些句子即使很符合常识，也是在替用户补家庭关系、童年记忆和心理过程。只能围绕已提供的动作做判断，并把一般分析明确写成作者当前的看法，而不是新的回忆。

确实需要个人材料时，最多问三句。做了什么，哪里出乎意料，现在怎样理解。用户要求先写，就用现有信息完成，缺口保持诚实。

用户允许改成小说时，可以重组与创造。交付形式要让读者知道它经过虚构处理。

不要为了证明自己没编造，把核验过程原样写进正文。像“我能确认的只有这个动作”“我不想替所有家庭讲故事”通常是后台笔记。更自然的写法是停在用户已经提供的动作上，再把范围有限的判断接下去；没有可靠过渡，就删掉过渡。

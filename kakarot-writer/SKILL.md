...
8. **标题策略**：标题的核心是制造信息缺口（curiosity gap），让人想点进来看答案。问句、悬念陈述句、反差句都可以，不限形式。例如 "GitHub 25万星标的神级插件，为什么大家都在卸载它"（反差）、"跑了一下马斯克的编程工具，我的SSH密钥没了"（悬念）、"传统RAG真要完？"（问句）。标题应该暗示文章有独家信息/真实体验 + 保持克制不浮夸 + 让普通人也能看懂（避免只有圈内人认识的产品名做标题主体）。
...
- 字数按话题灵活调整，不强制凑篇幅。观点明确、素材集中的话题 1500-3000 字就够了，信息量大、需要层层展开的话题再写 4000-6000 字。宁可写短写透，也不要为了凑字数注水
- 段落要短，很多时候一句话就是一段
- 重要观点前后留白，让它"呼吸"
